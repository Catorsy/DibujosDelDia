...
class CuriosityInfoFragment : Fragment() {
    ...
    private fun textDecor() {
        ...
        spannableMarsDescription.setSpan(StyleSpan(Typeface.BOLD), 539, 543, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        //RHAZ
        spannableMarsDescription.setSpan(BulletSpan(8, ContextCompat.getColor(
            requireContext(), R.color.purple_500)), 578, 579, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        spannableMarsDescription.setSpan(StyleSpan(Typeface.BOLD), 578, 582, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        //MAST
        spannableMarsDescription.setSpan(BulletSpan(8, ContextCompat.getColor(
            requireContext(), R.color.purple_500)), 615, 616, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        spannableMarsDescription.setSpan(StyleSpan(Typeface.BOLD), 615, 619, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        //CHEMCAM
        spannableMarsDescription.setSpan(BulletSpan(8, ContextCompat.getColor(
            requireContext(), R.color.purple_500)), 664, 671, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        spannableMarsDescription.setSpan(StyleSpan(Typeface.BOLD), 664, 672, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        //NAVCAM
        spannableMarsDescription.setSpan(BulletSpan(8, ContextCompat.getColor(
            requireContext(), R.color.purple_500)), 730, 735, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        spannableMarsDescription.setSpan(StyleSpan(Typeface.BOLD), 730, 736, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        //MAHLI
        spannableMarsDescription.setSpan(BulletSpan(8, ContextCompat.getColor(
            requireContext(), R.color.purple_500)), 765, 766, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        spannableMarsDescription.setSpan(StyleSpan(Typeface.BOLD), 765, 770, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
