...
import kotlinx.android.synthetic.main.activity_animations_fab.option_one_container
import kotlinx.android.synthetic.main.activity_animations_fab.option_two_container
import kotlinx.android.synthetic.main.activity_animations_fab.plus_imageview
import kotlinx.android.synthetic.main.activity_animations_fab.transparent_background
import kotlinx.android.synthetic.main.activity_anomation_fab2.*

class AnimationActivity7 : AppCompatActivity() {

    private var isExpanded = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_anomation_fab2)
        //тут у нас элевейшн
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_two_container.setOnClickListener {
                        Toast.makeText(this@AnimationActivity7, "Option 2",
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_one_container.setOnClickListener {
                        Toast.makeText(this@AnimationActivity7, "Option 1",
                            Toast.LENGTH_SHORT).show()
                    }
                }
            })
